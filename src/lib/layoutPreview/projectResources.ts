...
export interface Refs { drawables: Set<string>; layouts: Set<string> }

// Scan a layout XML for @drawable/NAME (src/background/anywhere) and @layout/NAME
// (from <include layout="@layout/NAME">). Cheap regex scan — no DOM needed.
